...
namespace WoodCarvingCamp.Data.Migrations
{
    ...
    [Migration("20230809100139_OrderTable")]
            ...
            modelBuilder.Entity("WoodCarvingCamp.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "15b3085c-0546-44b2-aedd-166121873ad1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPV6+0zsE/GnO4K22f1iJvb6ylhDznf1YvgOsJvTMHklJLpQpiNzz+Hq9McBtzHdJA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "144abb6e-623e-4af6-8b22-053cf272411f",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a4634865-1cad-4c44-a2d4-2722fdeabc33",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFLrgY3xccVJBNWW7QwmCJScuSkY7VguAcWBVP4Hy7tx/8zZU/sYyXRiAck0r06YCg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0ee3d05a-45bf-419f-833b-32ac600b389a",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("WoodCarvingCamp.Data.Models.GalleryPhoto", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 568, DateTimeKind.Local).AddTicks(9499),
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 568, DateTimeKind.Local).AddTicks(9564),
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 568, DateTimeKind.Local).AddTicks(9571),
            ...
            modelBuilder.Entity("WoodCarvingCamp.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 568, DateTimeKind.Local).AddTicks(9978),
                            ...
                            Price = 49.99m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 568, DateTimeKind.Local).AddTicks(9986)
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(1),
                            ...
                            Price = 15.99m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(5)
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(10),
                            ...
                            Price = 45.99m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(13)
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(18),
                            ...
                            Name = "Carving Knife",
                            Price = 9.99m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(21)
                        },
                        new
                        {
                            Id = 5,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(31),
                            Description = "Set of four knife made to help you carve your perfect project!",
                            ImageUrl = "/Images/ShopImages/Chisel two.jpg",
                            Name = "Small Carving Chisel For Wood Carving",
                            Price = 9.99m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(35)
                        },
                        new
                        {
                            Id = 6,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(41),
                            ...
                            Price = 20.00m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(44)
                        },
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(51),
                            Description = "Really good gloves to avoid accidentally cuts and injuries!",
                            ImageUrl = "/Images/ShopImages/Gloves two.jpg",
                            Name = "Wood Carving Gloves",
                            Price = 15.49m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(54)
                        },
                        new
                        {
                            Id = 8,
                            CategoryId = 5,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(59),
                            Description = "Tools storage to store your knifes, chisels and other accessories!",
                            ImageUrl = "/Images/ShopImages/Tools Storage.jpg",
                            Name = "Tools Storage",
                            Price = 30.49m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(62)
                        },
                        new
                        {
                            Id = 9,
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(72),
                            ...
                            Price = 30.49m,
                            UpdatedOn = new DateTime(2023, 8, 9, 13, 1, 38, 569, DateTimeKind.Local).AddTicks(75)
                        });
                });
